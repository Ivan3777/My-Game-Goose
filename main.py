...
player_start_y = (HEIGHT - player_rect.height) // 2
player_start_x_left = 50
player_rect.topleft = (player_start_x_left, player_start_y)
...
pygame.time.set_timer(CREATE_BONUS, 10000)
...
pygame.mixer.init()
background_music = pygame.mixer.Sound('1-track-1.mp3')
...
while playing:
    ...
    main_display.blit(FONT.render("Score: " + str(score), True,
                      COLOR_BLACK), (WIDTH-100, 20))
